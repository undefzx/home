...
hi Type gui=NONE guifg=#00FFFF guibg=DarkBlue
...
hi Special term=NONE cterm=NONE ctermfg=Yellow ctermbg=DarkBlue
hi Special gui=NONE guifg=Yellow guibg=DarkBlue

hi Constant term=NONE cterm=NONE ctermfg=Yellow ctermbg=DarkBlue
hi Constant gui=NONE guifg=Yellow guibg=DarkBlue
...
hi Comment term=NONE cterm=NONE ctermfg=DarkGreen ctermbg=DarkBlue
hi Comment gui=NONE guifg=#008080 guibg=DarkBlue

hi Identifier term=NONE cterm=NONE ctermfg=Green ctermbg=DarkBlue
hi Identifier gui=NONE guifg=Green guibg=DarkBlue
...
hi Pmenu ctermfg=Blue ctermbg=LightGray
hi Pmenu guifg=Blue guibg=LightGray
